...
if isDLL.lower() == 'yes':
	...
	ismayaosilangang= input('Are you from Brgy Mayao silangang? (yes/ no):  ')
	if ismayaosilangang.lower() == 'yes':
		...
		print('Sorry, this Scholarship grant are only for resident of mayao silangang')
else:
	print('Thanks for stopping by')